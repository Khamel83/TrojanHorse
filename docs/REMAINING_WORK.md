...
`.eml` parsing, source-backed views, and a tested Granola delta runner. It does
not yet provide a local answer-synthesis API/UI. The root `TrojanHorse/`
package, `th` CLI, and Atlas bridge are explicitly quarantined historical
material.

## Ordered next work

1. Build a local answer-synthesis/API or UI layer over the evidence views if
...
2. Optionally refine the 48 generic topic labels, people/organization aliases,
